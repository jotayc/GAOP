...
public class Core {
    ...
    public static final String VERSION = org.opencv.core.Core.getVersion();
    public static final String NATIVE_LIBRARY_NAME = org.opencv.core.Core.getNativeLibraryName();
    public static final int VERSION_MAJOR = org.opencv.core.Core.getVersionMajor();
    public static final int VERSION_MINOR = org.opencv.core.Core.getVersionMinor();
    public static final int VERSION_REVISION = org.opencv.core.Core.getVersionRevision();
    public static final String VERSION_STATUS = org.opencv.core.Core.getVersionStatus();
